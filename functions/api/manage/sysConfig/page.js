...
export async function getPageConfig(db, env) {
    ...
    config.push(
        ...
        },
        {
            ...
            tooltip: '1.填写 bing 使用必应壁纸轮播 <br/> 2.直接粘贴图片 URL 使用单张图片 <br/> 3.填写 ["url1","url2"] 使用多张图片轮播',
            tooltip_en: '1. Enter "bing" for Bing wallpaper rotation <br/> 2. Paste an image URL directly for a single image <br/> 3. Enter ["url1","url2"] for multiple images',
            category: '客户端设置',
            category_en: 'Client Settings',
        },
        {
